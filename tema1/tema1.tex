...
\begin{remark}
  ...
  % aproximaciones sucesivas se ha enunciado
  % en el algoritmo. Dada una tolerancia $\epsilon$, el algoritmo
  % realiza iteraciones hasta que se verifica el test de parada
  % $|x_{k+1}-x_k|<\epsilon$. Si $g$ es coerciva, este test de parada
  % está bien formulado, pues implica $|\cero-x_k|<\epsilon$ (ejercicio:
  % demostrar lo anterior, usando la desigualdad triangular y la
  % coercividad de $g$). En efecto, usando la desigualdad triangular,
  % \begin{align*}
