...
\begin{proof}
  ...
  $x\neq x_i$ para todo $i=0,...,n$. Para cada $t\in[a,b]$ consideramos
  \begin{equation}
...
los subintervalos $[x_{i-1},x_{i}]$, $i=1,...,n$, de modo que el grado
...
\begin{equation}
  ...
  \left\{\begin{array}{l}
     ...
     \begin{theorem}
       ...
       \end{equation*}
       donde $f[z_0,...,z_i]$ son las diferencias divididas de Newton
...
\begin{problema}
  ...
  \begin{problema}
    ...
    cualquiera $\{x_i\}$, siendo $i=0,...,n$ para un valor
