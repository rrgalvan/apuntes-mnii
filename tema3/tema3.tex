...
\begin{remark}~
  ...
  \item Aunque una primera impresión puede sugerir que las fórmulas de
    ...
    que el valor de $h$ difiere entre ellas. Si queremos comparar el
    ...
    \end{tabular}
    \end{enumerate}
  Como conclusión, en todos los casos \emph{el orden de error de las
  fórmulas cerradas es superior en dos unidades al de las fórmulas
  abiertas}.
  \end{enumerate}
\end{remark}
\begin{example}[Fórmulas de cuadratura abiertas]
  Si $[a,b]=[x_{0},x_{n}]$ y $f_k=f(x_k)$, $k=0,\dots,n$, se tienen
  las siguientes fórmulas de cuadratura de N--C cerradas junto con las
  expresiones de error asociadas:
  \label{sec:formulas-nc-abiertas}
  \begin{center}
...
\begin{example}[Fórmulas de cuadratura abiertas]
  Si $[a,b]=[x_{-1},x_{n+1}]$ y $f_k=f(x_k)$, $k=0,\dots,n$, se tienen
  las siguientes fórmulas de cuadratura de N--C abiertas junto con las
  expresiones de error asociadas:
  \label{sec:formulas-nc-abiertas}
  \begin{center}
