...
\begin{definition}
  ...
  \begin{align}
    ...
    n=0,...,N-k, \intertext{donde $\ddt y_{n+k}$ es un aproximación
      de $y'(t_{n+k})$ usando un cociente incremental con $k$ puntos:} \ddt
...
equivale a dividir todos los coeficientes por $\alpha_k$). Con
el fin de abreviar, con frecuencia usaremos la siguiente notación:
$$f_n=f(\tn,\yn).$$
...
\begin{example}[Método de \AB de dos pasos]
