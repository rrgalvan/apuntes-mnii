...
Los métodos de Runge-Kutta se basan en la idea de intentar obtener
...
\begin{align*}
    ...
    n=0,\dots, N-1, 
    \\
     \text{donde}\ k_i &= f(t_n+h\, c_i,\ y_n + h\, d_{n,i}), \text{\
      con }
    \left\{
      \begin{aligned}
        & c_i\in [0,1], \ c_0=1,\\ &d_{n,i} \text{ combinación
          lineal de } k_0,...,k_{i-1}.
      \end{aligned}
      \right.
\end{align*}
Si $b_1+b_2+\cdots+b_n=1$, entonces el método es consistente, pues
...
Runge-Kutta son convergentes y el orden de convergencia dependerá de
